        ...
        <div className="flex flex-wrap justify-center gap-8">
          {skills.map((skill) => (
            <div
              ...
              className={`w-36 h-36 flex flex-col items-center justify-center gap-1 rounded-xl shadow-lg hover:scale-110 hover:shadow-[var(--shadow-color)] dark:bg-white dark:shadow-md dark:shadow-[var(--dark-shadow-color)] dark:hover:shadow-lg dark:hover:shadow-[var(--dark-shadow-color)] transition-all ease-in-out duration-300`}
            >
              {skill.icon}
