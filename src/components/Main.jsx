  ...
  return (
    <div className="px-5 text-lightBlack">
      <div className="max-w-[1158px] mx-auto">
        ...
        <section
          id="home"
          className="flex items-center justify-center w-full py-12 md:py-24 lg:px-6 xl:px-0"
        >
        ...
        <section id="about" className="flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col items-center text-center gap-10 lg:flex-row">
            ...
            <p className="w-full text-sm tracking-wide leading-6 font-semibold lg:text-base lg:leading-7 lg:text-left">
