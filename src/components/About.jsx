      ...
      <div className="flex flex-col gap-10 lg:flex-row lg:gap-14">
        ...
        <div className="flex flex-col items-center self-center lg:items-start">
          <p className="text-sm text-center tracking-wide leading-6 font-semibold mb-6 lg:text-base lg:leading-7 lg:text-left">
            Hello World!{" "}
            <span className="text-primary">I'm Murali Krishnan</span>. I belong
            to <span className="text-primary">Madurai, India</span>. I have a
            Bachelor's Degree in Computer Science & Engg, yet I learned
